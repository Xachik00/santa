        ...
        <div className="container">
          <div className="conta">
            <div className="topBlock">
              <div className="btnBack" onClick={() => { setModal(true); setTransitonmodal(false) }} >
                <img src="/images/LeftVector.png" alt="BackIcon" />
              </div>
              <p className="topTitle">Վերցնել նամակը</p>
              <div className="close" onClick={() => setTransitonmodal(false)} >
            ...
            <div className="formContainer">
              ...
              <div className="bottomText">
                <p className="text1">
                  Մոտեցրեք նվերը Շունչ կենտրոն մինչև{" "}
                  <strong>Դեկտեմդերի 25</strong> -ը
                </p>
